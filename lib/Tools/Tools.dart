...
class _Tools extends State<Tools> {
  ...
  void performCheck() async {
    ...
    // Calculate averages
    int averageHeartRate = _calculateAverage(_heartRateValues);
    int averageSpO2 = _calculateAverage(_spo2Values);
    int averageCholesterol = _calculateAverage(_cholesterolValues);
